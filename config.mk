...
UCERNVM_VERSION = 2020.06@CernVM-5
UCERNVM_RELEASE = $(shell cat release)
KERNEL_VANILLA_VERSION = 5.4.44
KERNEL_CERNVM_RELEASE = 2
BB_UPSTREAM_VERSION = 1.31.1
BB_RELEASE = 1
CURL_UPSTREAM_VERSION = 7.70.0
CURL_RELEASE = 1
